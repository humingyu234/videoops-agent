...
import AppAuthClientPage from '@/pages/aivideo/app-auth-client';
import AppLoginLogPage from '@/pages/aivideo/app-login-log';
import AppRolePage from '@/pages/aivideo/app-role';
import AppSecurityAuditPage from '@/pages/aivideo/app-security-audit';
import AppSessionPage from '@/pages/aivideo/app-session';
import AppUserPage from '@/pages/aivideo/app-user';
import KnowledgePage from '@/pages/aivideo/knowledge';
import RunningHubAccountPage from '@/pages/aivideo/runninghub-account';
import WorkflowTemplatePage from '@/pages/aivideo/workflow-template';
...
const migratedPages: Record<string, React.ComponentType> = {
  'aivideo/app-auth-client/index': AppAuthClientPage,
  'aivideo/app-login-log/index': AppLoginLogPage,
  'aivideo/app-role/index': AppRolePage,
  'aivideo/app-security-audit/index': AppSecurityAuditPage,
  'aivideo/app-session/index': AppSessionPage,
  'aivideo/app-user/index': AppUserPage,
  'aivideo/knowledge/index': KnowledgePage,
