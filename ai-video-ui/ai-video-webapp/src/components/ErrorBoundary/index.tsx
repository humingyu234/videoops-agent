...
function formatFallbackMessage(id: string, defaultMessage: string): string {
  try {
        ...
        extra={[
          isChunkError && (
            <Button type="primary" key="retry" onClick={onRetry}>
              {formatFallbackMessage('app.error.retry', 'Retry')}
            </Button>
          ),
          <Button
            ...
            onClick={onReload}
          >
            {formatFallbackMessage('app.error.reload', 'Reload Page')}
          </Button>,
          <Button href="/" key="home">
            {formatFallbackMessage('app.error.home', 'Back Home')}
          </Button>,
        ].filter(Boolean)}
      />
    </Card>
