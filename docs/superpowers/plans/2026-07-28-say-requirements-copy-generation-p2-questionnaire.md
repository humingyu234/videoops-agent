...
- [ ] 前置阅读：完整读取 `ai-video-api/.codex/skills/ruoyi-plus-ai-coding/SKILL.md`、`references/backend.md`、generator 的 domain/service/serviceImpl/mapper 模板及最相似 P0-C/P1 Service；记录采用项。
