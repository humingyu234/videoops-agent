...
- 本地已存在项目规则要求的 `.agents/skills/ruoyi-plus-ai-coding/SKILL.md`（RuoYi Plus 人工智能编码规范）。进入后端实施前必须读取该技能，并按其要求继续阅读后端参考、代码生成模板与相似模块；如果后续工作区缺失该文件，才回退到官方 6.X 分支获取或等待团队安装。
