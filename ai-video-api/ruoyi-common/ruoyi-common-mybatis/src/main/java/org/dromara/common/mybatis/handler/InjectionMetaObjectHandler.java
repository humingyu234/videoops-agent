...
public class InjectionMetaObjectHandler implements MetaObjectHandler {
    ...
    private void fillAppAudit(BaseEntity baseEntity) {
        if (!baseEntity.getClass().isAnnotationPresent(AppAuditRequired.class)) {
            return;
        }
        Long actorId = AuditFillContext.currentActorId();
        baseEntity.setCreateBy(actorId);
        baseEntity.setUpdateBy(actorId);
