...
public class GlobalExceptionHandler {
    ...
    public R<Void> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException e, HttpServletRequest request) {
        ...
        String requiredTypeName = requiredType == null ? "未知类型" : requiredType.getName();
        return R.fail(String.format("请求参数类型不匹配，参数[%s]要求类型为：'%s'", e.getName(), requiredTypeName));
    }
    ...
    public R<Void> handleJsonParseException(JsonParseException e, HttpServletRequest request) {
        String requestURI = request.getRequestURI();
        log.warn("请求地址'{}'发生 JSON 解析异常", requestURI);
    ...
    public R<Void> handleHttpMessageNotReadableException(HttpMessageNotReadableException e, HttpServletRequest request) {
        log.warn("请求地址'{}'参数解析失败", request.getRequestURI());
