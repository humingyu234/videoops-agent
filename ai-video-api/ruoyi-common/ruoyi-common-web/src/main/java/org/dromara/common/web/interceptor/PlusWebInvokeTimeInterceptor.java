...
public class PlusWebInvokeTimeInterceptor implements HandlerInterceptor {
    ...
    /**
     * JSON 请求体无法安全结构化脱敏时写入日志的固定占位值。
     */
    private static final String UNPARSEABLE_JSON_OMITTED = "[unparseable JSON omitted]";
    ...
    private String sanitizeJsonParam(String jsonParam) {
        try {
            ...
            log.debug("[PLUS]请求参数 JSON 解析失败，已省略请求体");
            return UNPARSEABLE_JSON_OMITTED;
        }
    }
