...
public interface OssClient extends AutoCloseable {
    ...
    /** Downloads to a managed temporary file and returns a stream that deletes it on close. */
    InputStream doCustomBufferedDownload(Consumer<GetObjectRequest.Builder> getObjectRequestBuilderConsumer,
                                         Duration timeout);
