...
/**
 * 短信验证码提供方的 RuoYi Service 实现门面。
 */
public class AppSmsVerificationDeliveryServiceImpl implements IAppVerificationDeliveryService {

    private final AppSmsVerificationProvider provider;

    public AppSmsVerificationDeliveryServiceImpl(AppSmsVerificationProvider provider) {
